...
def build_and_save_imdb(path='/data/lisatmp4/carriepl/data/imdb_reviews/',
                        feat_type='BoW', ngram_range=(1, 1)):
    if feat_type == 'BoW':
        train_data_features, train_labels, unlab_data_features,\
            test_data_features, word_list = build_imdb_BoW(ngram_range=ngram_range)
...
if __name__ == '__main__':
    build_and_save_imdb(feat_type="BoW")
